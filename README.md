...
1. The "Smart Observer" (Zero Write Permissions): Safely connects to a company's observability stack (e.g., Datadog, Prometheus) and version control (GitHub/GitLab) with strictly read-only access. It cannot break that infrastructure.
